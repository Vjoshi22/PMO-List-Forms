...
import styles from './TileNavigaitonPmo.module.scss';
import { ITileNavigaitonPmoProps } from './ITileNavigaitonPmoProps';
...
export default class TileNavigaitonPmo extends React.Component<ITileNavigaitonPmoProps, InavigationState> {
  constructor(props: ITileNavigaitonPmoProps, state: InavigationState) {
    super(props);
  ...
  public render(): React.ReactElement<ITileNavigaitonPmoProps> {
